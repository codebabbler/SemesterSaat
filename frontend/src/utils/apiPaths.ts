...
export const API_PATHS = {
  ...
  INCOME: {
    ...
    TOGGLE_RECURRING_INCOME: (incomeId: string) => `/api/v1/income/${incomeId}/toggle-recurring`,
  ...
  EXPENSE: {
    ...
    TOGGLE_RECURRING_EXPENSE: (expenseId: string) => `/api/v1/expense/${expenseId}/toggle-recurring`,
